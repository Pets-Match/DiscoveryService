...
var CreatePetController = /** @class */ (function () {
    ...
    CreatePetController.prototype.execute = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, age, specie, race, gender, ownerId, pet, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, name = _a.name, age = _a.age, specie = _a.specie, race = _a.race, gender = _a.gender, ownerId = _a.ownerId;
